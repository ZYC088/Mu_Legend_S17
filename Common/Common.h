...
enum
{
	...
	DB_CLASS_LIGHT_WIZARD1			= 0xB0
	DB_CLASS_LIGHT_WIZARD2			= 0xB1
	DB_CLASS_LIGHT_WIZARD3			= 0xB3
	DB_CLASS_LIGHT_WIZARD4			= 0xB7

	DB_CLASS_LEMURIA_MAGE1			= 0xC0
	DB_CLASS_LEMURIA_MAGE2			= 0xC1
	DB_CLASS_LEMURIA_MAGE3			= 0xC3
	DB_CLASS_LEMURIA_MAGE4			= 0xC7
...
namespace Character
{
	...
	inline bool Allowed(uint8 race)
	{
		return ( race == DB_CLASS_DARK_WIZARD ||
				 ...
				 race == DB_CLASS_LIGHT_WIZARD1 ||
				 race == DB_CLASS_LEMURIA_MAGE1);
	}
	...
	inline bool AllowedDB(uint8 const race)
	{
		return ( race == DB_CLASS_DARK_WIZARD		|| race == DB_CLASS_SOUL_MASTER			|| race == DB_CLASS_GRAND_MASTER 		|| race == DB_CLASS_SOUL_WIZARD 			||
				 ...
				 race == DB_CLASS_LIGHT_WIZARD1		|| race == DB_CLASS_LIGHT_WIZARD2		|| race == DB_CLASS_LIGHT_WIZARD3		|| race == DB_CLASS_LIGHT_WIZARD4 			||
				 race == DB_CLASS_LEMURIA_MAGE1		|| race == DB_CLASS_LEMURIA_MAGE2		|| race == DB_CLASS_LEMURIA_MAGE3		|| race == DB_CLASS_LEMURIA_MAGE4);
	}
}
...
static uint8 CharacterToDB[Character::MAX_CLASS] =
{
	...
	DB_CLASS_LIGHT_WIZARD1,
	DB_CLASS_LEMURIA_MAGE1,
};
